        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            {productData.isPremium && (
              <div className="bg-amber-400 text-white px-4 py-2 rounded-lg flex items-center gap-2 text-sm font-medium">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 pb-24 md:pb-6">
          ...
          <div className="bg-background rounded-xl p-6 h-fit">
            ...
            <div className="flex items-start justify-between mb-2">
              <div className="flex items-center gap-2">
                <span className="text-4xl font-bold text-foreground">{productData.price}</span>
                ...
                <span className="text-muted-foreground">/{productData.unit}</span>
              </div>
              <button
                type="button"
            ...
            {/* Name and Location */}
            <h1 className="text-2xl font-bold text-foreground mb-1">{productData.name}</h1>
            <p className="text-muted-foreground mb-4">{productData.location}</p>
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground mb-4 pb-4 border-b border-border">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span>{productData.favorites} Фаворитов</span>
              </div>
              <div className="flex items-center gap-1.5">
                <Calendar className="h-4 w-4" />
                <span>{productData.date} Дата Размещения</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="font-semibold text-foreground">{productData.seller.name}</span>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <span className="font-medium">{productData.article}</span>
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex-1 mx-2 border-b border-dotted border-muted-foreground/30" />
                <span className="font-medium">{productData.country}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="md:hidden space-y-4">
          ...
          <div className="bg-background rounded-xl p-4">
            ...
            <div className="flex items-start justify-between mb-2">
              <div className="flex items-center gap-2">
                <span className="text-3xl font-bold text-emerald-600">{productData.price}</span>
                <div className="flex items-center gap-1">
                  <span className="w-6 h-6 rounded-full bg-muted flex items-center justify-center text-xs font-medium">
                    ₾
                  </span>
                ...
                <span className="text-muted-foreground text-sm">
                  /{productData.unit} (Макс. {productData.maxQuantity} кг)
                </span>
              </div>
              <button
                type="button"
            ...
            {/* Name and Location */}
            <h1 className="text-xl font-bold text-foreground mb-1">{productData.name}</h1>
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-muted-foreground mb-3 pb-3 border-b border-border">
              ...
              <div className="flex items-center gap-1.5 w-full">
                <Calendar className="h-4 w-4" />
                <span>Дата Размещения: {productData.date}</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex-1 mx-2 border-b border-dotted border-muted-foreground/30" />
                <div className="flex items-center gap-2">
                  <span className="font-medium text-sm">{productData.article}</span>
                  <button
                    type="button"
                    onClick={handleCopyArticle}
                    className="p-1 hover:bg-muted rounded"
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex-1 mx-2 border-b border-dotted border-muted-foreground/30" />
                <span className="font-medium text-sm">{productData.category}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-muted-foreground text-sm">Страна Происхождения</span>
                <div className="flex-1 mx-2 border-b border-dotted border-muted-foreground/30" />
                <span className="font-medium text-sm">{productData.country}</span>
              </div>
            </div>
          </div>
